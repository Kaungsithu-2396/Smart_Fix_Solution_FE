...
function About() {
    ...
    return (
        <section className=" w-2/3 m-auto md:pt-8 xl:h-screen grid grid-cols-1 2xl:grid-cols-2 justify-center gap-3 lg:gap-10 ">
            <div className="">
                <h1 className=" font-bold text-3xl">About Us</h1>
                <p className="my-4 sm:text-justify ">
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                    Quam fuga esse error. Sed ipsam nesciunt consequuntur
                    nostrum perferendis eligendi rem, itaque, alias blanditiis
                    laborum explicabo sequi suscipit. Consequuntur, inventore
                    vitae?Lorem ipsum dolor sit amet consectetur adipisicing
                    elit. Omnis molestias necessitatibus molestiae, veritatis
                    odio quidem cupiditate. Doloremque, explicabo dolorem!
                    Consectetur et repellendus exercitationem fuga optio
                    reiciendis laudantium! Molestiae, perspiciatis unde.
                </p>
                <p
                    className={`${
                ...
                >
                    ...
                    impedit laboriosam error quasi, fugit autem? Repudiandae
                    quam dignissimos deserunt facilis blanditiis numquam itaque
                    nam nulla assumenda vel? Aliquid, non earum.
                </p>
                <div className={` my-5`}>
